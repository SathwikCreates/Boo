              ...
              <div className="space-y-4">
                <div className="flex gap-1 bg-muted/20 rounded-lg p-1">
                  <button
                    ...
                    className={`flex-1 px-3 py-2 text-xs font-medium rounded-md transition-colors ${loginMethod === 'password'
                  ...
                  <button
                    ...
                    className={`flex-1 px-3 py-2 text-xs font-medium rounded-md transition-colors ${loginMethod === 'phrase'
                        ? 'bg-primary/20 text-primary border border-primary/30'
                        : 'text-gray-400 hover:text-white'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 px-3 py-2 text-xs font-medium rounded-md transition-colors ${loginMethod === 'emergency'
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-border/50 rounded-lg p-6 text-center">
                      ...
                      {errors.emergencyKeyFile && (
                        <p className="text-sm text-red-400 mt-2">{errors.emergencyKeyFile as unknown as string}</p>
                      )}
                    </div>
                    <p className="text-xs text-gray-400">
